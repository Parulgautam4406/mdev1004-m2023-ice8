...
class CRUDViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
    ...
    {
        guard let url = URL(string: "https://livesite-assignment-2.onrender.com/api/list") else
        {
            print("URL Error")
    ...
    func deleteMovie(at indexPath: IndexPath)
    {
        ...
        guard let url = URL(string: "https://livesite-assignment-2.onrender.com/api/delete/\(movie._id)") else {
            print("Invalid URL")
            return
        }
